...
| `test_registry.py` | trust formula (log10, fork/README penalti, llms bonus), alias/builtin offline (incl. requests root P1-06), merge versi (Bug 6), filter sampah (SAB-5) |
